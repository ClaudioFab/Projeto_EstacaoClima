...
public class Main_EstacaoClima {
    ...
    public static void main(String[] args) {
        ...
        Clima base = new Clima(0);

        double valorCel = Clima.buscarCelcius(0);

        base.setCelcius(valorCel);

        //ou resumir base.setCelcius(Clima.buscarCelcius(0));
        menu(base);
    }
    public static void menu(Clima base){

        do {
            int esc = Integer.parseInt(JOptionPane.showInputDialog(null,"(Temperatura em Celsius "+base.getCelcius()+"°C)\n\nEscolha a opção desejada:\n\n(1) Converter a temperatura para Fahrenheit.\n\n(2) Converter a temperatura para Kelvin.\n\n(3) Informar se o clima está quente, agradável ou frio.\n\n(4) Selecionar uma nova temperatura.\n\n(5) Sair do programa.\n___________________________________________","Mini Estação do Clima",JOptionPane.QUESTION_MESSAGE));

        switch (esc) {
            case 1:
                double fahrenheit = base.buscarFahrenheit(base.getCelcius());
                JOptionPane.showMessageDialog(null,"Converção em Fahrenheit: "+fahrenheit+"ºF.","Celsius "+base.getCelcius()+"ºC para Fahrenheit",JOptionPane.INFORMATION_MESSAGE);
                break;
            case 2:
                double kelvin = base.buscarKelvin(base.getCelcius());
                JOptionPane.showMessageDialog(null,"Converção em Kelvin: "+kelvin+" K.","Celsius "+base.getCelcius()+"ºC para Kelvin",JOptionPane.INFORMATION_MESSAGE);
                break;
            case 3:
